...
<div class="header high">
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/cli/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
  for (; i &lt; length; i++) {
    ...
    if (lead === '"' || lead === '\'') {
      ...
      args.push(grouped);
    } else <span class="missing-if-branch" title="if path not taken"" >I</span>if (open) {
<span class="cstat-no" title="statement not covered" >      grouped += ' ' + parts[i];</span>
    } else {
      args.push(parts[i]);
    }
  }
