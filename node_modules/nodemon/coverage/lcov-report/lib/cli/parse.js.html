...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">87.67% <small>(64 / 73)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">82.76% <small>(72 / 87)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/cli/</a> &#187; parse.js</div>
</div>
<div class="body">
...
function nodemonOption(options, arg, eatNext) {
  if (arg.indexOf('--debug') === 0 || arg === '--debug-brk' || arg === '--nodejs' || arg.indexOf('--harmony') === 0) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (!options.nodeArgs) { options.nodeArgs = []; }
    options.nodeArgs.push(arg);
  }
  // line seperation on purpose to help legibility
  else <span class="missing-if-branch" title="if path not taken"" >I</span>if (arg === '--help' || arg === '-h' || arg === '-?') {
...
<span class="cstat-no" title="statement not covered" >    options.includeHidden = true;</span>
  }
&nbsp;
