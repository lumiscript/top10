...
<div class="header high">
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/config/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (options.watch &amp;&amp; options.watch.length) {
      options.monitor = utils.clone(options.watch);
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (options.ignore) {
      [].push.apply(options.monitor, (options.ignore || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.map(function (rule) {
        return '!' + rule;
      }));
    }
&nbsp;
