...
<div class="header medium">
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/config/</a> &#187; load.js</div>
</div>
<div class="body">
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken"" >I</span>if (config.loaded.length === 0 &amp;&amp; options.ignore.length === 0) {
        // TODO decide whether this is just confusing...
<span class="cstat-no" title="statement not covered" >        var legacy = loadLegacyIgnore.bind(null, options, ready);</span>
&nbsp;
        // first try .nodemonignore, if that doesn't exist, try nodemon-ignore
<span class="cstat-no" title="statement not covered" >        return legacy('.nodemonignore', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >          legacy('nodemon-ignore', <span class="fstat-no" title="function not covered" >function (options) {</span></span>
 ...
 */
<span class="fstat-no" title="function not covered" >function loadLegacyIgnore(options, success, filename, fail) {</span>
<span class="cstat-no" title="statement not covered" >  var ignoreFile = path.join(process.cwd(), filename);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exists(ignoreFile, <span class="fstat-no" title="function not covered" >function (exists) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (exists) {</span>
<span class="cstat-no" title="statement not covered" >      return parse(ignoreFile, <span class="fstat-no" title="function not covered" >function (error, rules) {</span></span>
<span class="cstat-no" title="statement not covered" >        options.ignore = rules.raw;</span>
